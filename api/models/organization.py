...
class Tribe(MerlinBaseModel):
	class OrgCategory(models.TextChoices):
		TECH = "TECH", "فنی"
		NON_TECH = "NON_TECH", "غیر فنی"

	name = models.CharField(max_length=256, verbose_name="نام")
	department = models.ForeignKey(Department, on_delete=models.SET_NULL, null=True, verbose_name="دپارتمان")
	category = models.CharField(max_length=16, choices=OrgCategory.choices, null=True, blank=True, verbose_name="دسته بندی")
	leader = models.ForeignKey(
		"api.User",
		on_delete=models.PROTECT,
		null=True,
...
class Team(MerlinBaseModel):
	...
	category = models.CharField(max_length=16, choices=Tribe.OrgCategory.choices, null=True, blank=True, verbose_name="دسته بندی")
	description = models.TextField(blank=True, verbose_name="توضیحات")
